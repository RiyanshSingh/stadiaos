...
const content = `import { ArrowLeft, User, Globe, Bell, Accessibility, LogOut, ChevronRight } from 'lucide-react'
...
fs.writeFileSync('src/app/fan/SettingsView.tsx', content);
