...
const content = `import { ArrowLeft, Search, Filter, Coffee, ShoppingBag, Stethoscope, Droplets, User, Navigation2, MapPin, Clock, Activity, Accessibility, Navigation, ArrowRight, HelpCircle } from 'lucide-react'
...
fs.writeFileSync('src/app/fan/QueuesFacilitiesView.tsx', content);
console.log('Queues facilities updated');
