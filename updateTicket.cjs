...
const content = `import { ArrowLeft, MapPin, Navigation, QrCode, ShieldAlert, Coffee } from 'lucide-react'
        ...
        <section>
          <Card className={cn(
            ...
            <div className="flex justify-between items-start mb-8 relative z-10">
              <div className="pr-4">
                <p className="text-[10px] font-bold uppercase tracking-widest text-white/40 mb-2">Match Pass</p>
            ...
            <div className="flex items-center justify-between bg-white/[0.03] p-4 rounded-2xl border border-white/10">
              ...
              <span className="text-[15px] font-bold tracking-tight text-white">Gate C</span>
            </div>
          </Card>
        </section>
...
fs.writeFileSync('src/app/fan/TicketSeatView.tsx', content);
console.log('Ticket & Seat updated');
