...
const content = `import { ArrowLeft, Clock, MapPin, Navigation, ShieldAlert, Accessibility, Activity } from 'lucide-react'
...
fs.writeFileSync('src/app/fan/FacilityDetailView.tsx', content);
console.log('Facility view updated');
